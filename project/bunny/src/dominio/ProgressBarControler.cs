...

{
    class ProgressBarControler : Observador
    {
        ...
        {
            if (Globals.state == 0) { 
                if(Globals.ProgressBar_hambre.Value >= 20) setBarBaño(-7); //Si tiene comida entonces puede hacer caca
                setBarHambre(-3);
                setBarSueño(-1);
                ...
                if (Globals.ProgressBar_sueño.Value <= 20) ani_cansancio.cansancioStart();
